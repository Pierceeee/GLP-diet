...
// Order Page #4 — 81% Discount for Non-Buyers (Final Offer)
const PLANS: PlanTier[] = [
  { id: "7d", label: "7-day plan", originalPrice: 13.24, price: 2.51, perDay: "0.36" },
  { id: "1mo", label: "1-month plan", originalPrice: 26.51, price: 5.04, perDay: "0.16", popular: true },
  { id: "3mo", label: "3-month plan", originalPrice: 44.88, price: 8.53, perDay: "0.09" },
];
...
function OfferNonBuyers3Content() {
  ...
  const handleGetPlan = useCallback((planId: string) => {
    alert(`Proceeding to checkout with plan: ${planId} (81% discount)`);
  }, []);

  const handleDecline = useCallback(() => {
    // Last offer — nowhere else to go
...
// --------------- PAGE EXPORT ---------------
export default function OfferNonBuyers3Page() {
  return (
    <Suspense
      fallback={
