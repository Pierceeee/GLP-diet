...
// Order Page #3 — 74% Discount for Non-Buyers
const PLANS: PlanTier[] = [
  { id: "7d", label: "7-day plan", originalPrice: 13.24, price: 3.44, perDay: "0.49" },
  { id: "1mo", label: "1-month plan", originalPrice: 26.51, price: 6.89, perDay: "0.22", popular: true },
  { id: "3mo", label: "3-month plan", originalPrice: 44.88, price: 11.66, perDay: "0.13" },
];
    ...
    <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl max-w-sm w-full p-6 shadow-xl">
        ...
        <p className="text-[14px] text-[var(--text-secondary)] text-center mb-6">
          We have a special <span className="font-bold text-[var(--brand)]">81% discount</span> offer
