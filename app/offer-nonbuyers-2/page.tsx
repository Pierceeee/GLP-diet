...
const PLANS: PlanTier[] = [
  { id: "7d", label: "7-Day Programme", originalPrice: 13.24, price: 3.44, perDay: "0.49" },
  { id: "1mo", label: "1-Month Programme", originalPrice: 26.51, price: 6.89, perDay: "0.22", popular: true },
  { id: "3mo", label: "3-Month Programme", originalPrice: 44.88, price: 11.66, perDay: "0.13" },
];
  ...
  return (
    <div className="sticky top-0 z-50 bg-[#d4edda] border-b border-[#b8dabd]">
      <div className="w-full max-w-[660px] mx-auto px-4 py-3 flex items-center justify-between">
        <div>
          <p className="text-[15px] font-bold text-[#0f4c4c]">Your {DISCOUNT_LABEL} is locked in</p>
        </div>
        <button
          onClick={onGetPlan}
