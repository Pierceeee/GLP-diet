...
const MALE_SVG_PATHS: Record<string, string[]> = {
  arms: [
    // Left upper arm — shoulder cap down to elbow area
    `M 398,215 C 382,230 365,255 352,285
     C 342,308 336,330 334,348
     C 332,362 336,372 345,378
     C 355,385 368,395 378,405
     C 388,415 395,420 400,418
     C 410,412 416,395 418,375
     C 420,355 418,330 414,308
     C 410,285 405,258 402,235 Z`,
    // Right upper arm
    `M 602,215 C 618,230 635,255 648,285
     C 658,308 664,330 666,348
     C 668,362 664,372 655,378
     C 645,385 632,395 622,405
     C 612,415 605,420 600,418
     C 590,412 584,395 582,375
     C 580,355 582,330 586,308
     C 590,285 595,258 598,235 Z`,
  ],
  chest: [
    // Left pec
